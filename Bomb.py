...
\033[1;31m---------------------------------------
\033[1;35mCODED BY   : \033[33mMr.BL4Z3
\033[1;35mGITHUB     : \033[1;33mgithub.com/T34mV18rs
...
def sms_bombing():
    ...
    for sms in range(limit):
        ...
        print "\033[1;31m--------------------------"
        if sms_limit == limit:
           os.system('xdg-open https://github.com/T34mV18rs')
def intro():
    os.system('clear')
    print logo
    print ""
    ...
    if user_choise == "1":
       sms_bombing()
         ...
         os.system('xdg-open https://github.com/T34mV18rs/V18rs-Bomb')
         os.system('xdg-open https://github.com/T34mV18rs/V18rs-Bomb')
    elif user_choise == "3":
         os.system('clear')
